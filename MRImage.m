classdef MRImage < handle
    ...
    methods
        ...
        function obj=preprocessing(obj, windowSizes)
            ...
            obj.slidingKurt=movKurtosis(unblackData, windowSizes.kurt, obj.medianValue);
        end
        ...
        function seedCoordinates=seedAndFlood(obj, settings)
            ...
            if sum(obj.floodedMap(:))>0.7*obj.d(1)*obj.d(2) %means that the flood leaked everywhere
                obj.floodedMap=[];
            end
